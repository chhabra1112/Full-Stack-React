...
import {Breadcrumb,BreadcrumbItem, Form, Label, Col, Button, Row} from 'reactstrap';
                ...
                <div className="col-12 col-md-9">
                    <LocalForm onSubmit={(values)=>this.handleSubmit(values)}>
                        ...
                        <Row className="form-group">
                            ...
                            <Col md={10}>
                                <Control.text model=".telnum" id="telnum" name="telnum" placeholder="XXX-XXXXXX" 
                                className="form-control" />
                        ...
                        <Row className="form-group">
                            ...
                            <Col md={10}>
                                <Control.textarea model=".message" id="message" name="message" placeholder="Feedback" className="form-control"/>
                            </Col>
                        </Row>
                        <Row className="form-group">
