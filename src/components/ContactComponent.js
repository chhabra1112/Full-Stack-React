                ...
                <div className="col-12 col-md-9">
                    <Form onSubmit={this.handleSubmit}>
                        ...
                        <FormGroup row>
                            ...
                            <Col md={10}>
                                <Input type="number" id="telnum" name="telnum" placeholder="XXX-XXXXXX" value={this.state.telnum} onChange={this.handleInputChange}/>
                            </Col>
                        </FormGroup>
                        <FormGroup row>
                        ...
                        <FormGroup row>
                            ...
                            <Col md={10}>
                                <Input type="textarea" id="message" name="message" placeholder="Feedback" value={this.state.message} onChange={this.handleInputChange}/>
                            </Col>
                        </FormGroup>
                        <FormGroup>
